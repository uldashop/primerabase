...
if($alternativeProductsTitle){
    ...
    newTitleAlternativeProducts.innerHTML ='<section data-name="Title style 2" class="title_ulda"> <div class="row s_nb_column_fixed"> <div class="col-lg-12 te_title_2 pt32 pb32"><div class="te_title_sub_div"><h4 class=" te_s_title_default te_title_style2 o_default_snippet_text mb-0 pb-0">OTROS RECOMENDADOS</h4> </div> </div> </div> </section>';
